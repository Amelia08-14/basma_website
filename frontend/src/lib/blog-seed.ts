    ...
    translations: {
      en: {
        ...
        blocks: [
          ...
          { type: 'p', text: 'As a result, learners complete programs without necessarily being prepared for real-world challenges.' },
          ...
          { type: 'p', text: 'From energy diversification to digitalization, entrepreneurship, and industrial development, the region is moving fast.' },
          ...
          { type: 'ul', items: ['companies struggle to find job-ready talent', 'employees lack relevant, applicable skills', 'economic growth is slowed by capability gaps'] },
          ...
          { type: 'p', text: 'Fit-for-purpose, adaptive, and modular development programs offer a more relevant alternative to traditional approaches.' },
          ...
          { type: 'p', text: 'A-la-carte learning allows individuals and organizations to focus on what truly matters.' },
          { type: 'p', text: 'Instead of following long, rigid programs, learners can:' },
          { type: 'ul', items: ['acquire skills when they are needed', 'adapt learning paths to their roles', 'stay aligned with industry evolution'] },
          ...
          { type: 'p', text: 'Organizations across MENA are increasingly recognizing that their competitive advantage lies in their people.' },
          ...
          { type: 'ul', items: ['improved productivity', 'stronger leadership pipelines', 'higher employee engagement and retention', 'faster adoption of new technologies', 'better operational performance'] },
          ...
          { type: 'ul', items: ['Inclusive: accessible regardless of location or background', 'Adaptive: evolving with industry needs', 'Practical: grounded in real-world challenges', 'Human-centric: developing leadership, resilience, and curiosity', 'Digitally enabled: using technology to scale impact'] },
          ...
          { type: 'p', text: 'As business leaders, educators, and innovators, the responsibility is clear: to design development programs that are relevant, flexible, and aligned with real economic needs.' },
      ...
      fr: {
        ...
        blocks: [
          { type: 'p', text: "À travers le Moyen-Orient et l'Afrique du Nord, la conversation autour de l'éducation et du développement professionnel évolue rapidement. La région possède l'une des populations les plus jeunes et dynamiques au monde, mais l'accès à un apprentissage de qualité, pertinent et à jour reste inégal." },
          { type: 'p', text: "Le défi n'est pas un manque de talent. C'est un manque d'alignement." },
          { type: 'p', text: "Malgré un fort potentiel et des pôles d'excellence, l'écosystème global de l'apprentissage peine encore à suivre le rythme des économies modernes et des industries en constante mutation." },
          ...
          { type: 'p', text: "De nombreux apprenants ne bénéficient pas de la même exposition, des mêmes infrastructures ou de la même adaptabilité que dans des systèmes éducatifs plus matures. Les modèles traditionnels, encore largement utilisés, reflètent rarement les exigences réelles du monde du travail actuel." },
          { type: 'p', text: "Cela crée un écart — non pas de capacité, mais d'opportunité." },
          { type: 'h2', text: 'Les limites des modèles standardisés' },
          { type: 'p', text: "Pendant des décennies, des programmes standardisés « one-size-fits-all » ont façonné les systèmes d'éducation et de formation. Efficaces hier, ils ne sont plus adaptés à l'environnement actuel." },
          { type: 'p', text: "Aujourd'hui, la main-d'œuvre doit être :" },
          { type: 'ul', items: ['agile', 'à l’aise avec le digital', 'capable d’apprendre en continu', 'dotée à la fois de compétences techniques et humaines'] },
          { type: 'p', text: "Pourtant, de nombreux programmes dans la région reposent encore sur des contenus dépassés, des structures rigides et une application pratique limitée." },
          { type: 'p', text: "Résultat : les apprenants terminent des parcours sans être réellement préparés aux défis du terrain." },
          ...
          { type: 'p', text: "Diversification énergétique, digitalisation, entrepreneuriat, développement industriel… la région avance vite." },
          ...
          { type: 'ul', items: ['les entreprises peinent à recruter des talents « job-ready »', 'les collaborateurs manquent de compétences applicables et pertinentes', 'la croissance est ralentie par des écarts de capacités'] },
          ...
          { type: 'p', text: "Des programmes adaptatifs, modulaires et « fit-for-purpose » offrent une alternative plus pertinente aux approches traditionnelles." },
          { type: 'p', text: 'Ils se concentrent sur :' },
          { type: 'ul', items: ['les besoins business réels plutôt que des curricula génériques', 'des compétences spécifiques par secteur (énergie, tech, finance, santé, etc.)', 'la flexibilité et l’accessibilité', 'la pratique plutôt que la théorie'] },
          ...
          { type: 'ul', items: ['acquérir des compétences au moment où elles sont nécessaires', 'adapter les parcours à leurs rôles', 'rester alignés avec l’évolution de leur industrie'] },
          ...
          { type: 'ul', items: ['une productivité améliorée', 'des pipelines de leadership renforcés', 'un engagement et une rétention plus élevés', 'une adoption plus rapide des nouvelles technologies', 'une meilleure performance opérationnelle'] },
          ...
          { type: 'p', text: "Pour libérer tout son potentiel, la région doit passer d'un modèle statique à un écosystème d'apprentissage dynamique." },
          { type: 'p', text: "Le futur de l'apprentissage au MENA devrait être :" },
          { type: 'ul', items: ['Inclusif : accessible quel que soit le lieu ou le parcours', 'Adaptatif : évoluant avec les besoins des industries', 'Pratique : ancré dans des défis concrets', 'Centré humain : développant leadership, résilience et curiosité', 'Porté par le digital : utilisant la technologie pour scaler l’impact'] },
          { type: 'h2', text: 'Conclusion' },
          ...
          { type: 'p', text: "En tant que leaders business, éducateurs et innovateurs, la responsabilité est claire : concevoir des programmes pertinents, flexibles et alignés sur les besoins économiques réels." },
  ...
  },
  {
    ...
    translations: {
      en: {
        ...
        blocks: [
          { type: 'p', text: "In today's environment, where technologies, markets, and customer expectations evolve at unprecedented speed, organizations face a critical challenge: their ability to develop talent often lags behind the pace of change." },
          { type: 'p', text: 'What increasingly differentiates high-performing organizations is not only what they know, but how fast they can learn, adapt, and build new capabilities.' },
          ...
          { type: 'p', text: 'Many organizations still rely on training approaches designed for a more stable and predictable world. These models tend to be linear, standardized, and disconnected from real operational needs.' },
          { type: 'p', text: "In today's context, this creates significant limitations." },
          { type: 'p', text: 'Traditional training often results in:' },
          { type: 'ul', items: ['slow time-to-competency, delaying impact on the ground', 'low knowledge retention and limited practical application', 'weak alignment with evolving roles, technologies, and business priorities'] },
          { type: 'p', text: 'As a result, organizations experience operational inefficiencies, increased costs, and growing talent gaps.' },
          { type: 'h2', text: 'The Shift Toward Modern Learning' },
          { type: 'p', text: 'Modern learning is not simply about moving content online. It is about fundamentally rethinking how capabilities are developed.' },
          ...
          { type: 'ul', items: ['up to 50% faster time-to-competency', 'up to 40% reduction in training delivery costs', 'up to 45% increase in knowledge retention', 'strong learner preference for flexible, digital formats'] },
          ...
          { type: 'p', text: 'Organizations that invest in adaptive and targeted learning approaches consistently outperform others.' },
          { type: 'p', text: 'The impact is visible across multiple dimensions:' },
          { type: 'ul', items: ['higher productivity and operational efficiency', 'faster adoption of new technologies and processes', 'stronger leadership development and internal mobility', 'improved employee engagement and retention', 'greater consistency in quality, safety, and execution'] },
          { type: 'p', text: 'Learning, in this context, becomes a core business capability — directly linked to performance and growth.' },
          { type: 'h2', text: "Building a Learning Architecture for Today's Reality" },
          { type: 'p', text: "High-performing organizations are moving away from isolated training initiatives toward integrated learning ecosystems." },
          { type: 'p', text: 'These systems are:' },
          { type: 'ul', items: ['adaptive, evolving alongside business needs', 'modular and on-demand, enabling just-in-time learning', 'application-focused, grounded in real tasks and scenarios', 'human-centric, supporting autonomy, motivation, and mastery', 'digitally enabled, leveraging data, technology, and scalable platforms'] },
          { type: 'p', text: 'This transformation shifts learning from a one-time intervention to a continuous process embedded in daily work.' },
          { type: 'h2', text: 'Conclusion' },
          { type: 'p', text: 'The organizations that will lead in the coming years are not necessarily those with the most resources, but those with the strongest ability to learn and adapt.' },
          { type: 'p', text: 'Modern learning enables companies to:' },
          { type: 'ul', items: ['move faster', 'reduce costs', 'strengthen capabilities at scale'] },
          { type: 'p', text: 'For organizations committed to building resilient, high-performance teams, investing in modern learning is no longer optional. It is a strategic decision that directly shapes future performance.' },
        ],
      },
      fr: {
        title: "Pourquoi l'apprentissage moderne est un impératif stratégique pour les organisations à haute performance",
        description: "Dans un monde qui change vite, l'apprentissage moderne devient un moteur stratégique : acquisition plus rapide, pertinence accrue, impact mesurable sur le terrain.",
        blocks: [
          { type: 'p', text: "Dans l'environnement actuel, où les technologies, les marchés et les attentes clients évoluent à une vitesse inédite, les organisations font face à un défi critique : leur capacité à développer les talents est souvent en retard par rapport au rythme du changement." },
          { type: 'p', text: "Ce qui différencie de plus en plus les organisations les plus performantes, ce n'est pas seulement ce qu'elles savent, mais la vitesse à laquelle elles apprennent, s'adaptent et construisent de nouvelles capacités." },
          ...
          { type: 'p', text: "Beaucoup d'organisations s'appuient encore sur des approches de formation conçues pour un monde plus stable et prévisible. Ces modèles sont souvent linéaires, standardisés, et déconnectés des besoins opérationnels réels." },
          ...
          { type: 'ul', items: ['un time-to-competency lent, qui retarde l’impact sur le terrain', 'une faible rétention et une application pratique limitée', 'un alignement faible avec l’évolution des rôles, technologies et priorités business'] },
          ...
          { type: 'p', text: "L'apprentissage moderne ne consiste pas simplement à mettre du contenu en ligne. Il s'agit de repenser en profondeur la manière dont les capacités sont développées." },
          { type: 'p', text: 'Il repose sur trois dimensions clés :' },
          { type: 'ul', items: ['vitesse : accélérer l’acquisition de compétences', 'pertinence : aligner la formation avec les besoins business réels', 'impact : s’assurer que les connaissances sont appliquées en pratique'] },
          ...
          { type: 'ul', items: ['jusqu’à 50% de time-to-competency en moins', 'jusqu’à 40% de réduction des coûts de délivrance', 'jusqu’à 45% d’augmentation de la rétention', 'une forte préférence des apprenants pour des formats flexibles et digitaux'] },
          ...
          { type: 'p', text: "Les organisations qui investissent dans des parcours adaptatifs et ciblés surperforment plus souvent que les autres." },
          { type: 'p', text: 'L’impact se voit à plusieurs niveaux :' },
          { type: 'ul', items: ['productivité et efficience opérationnelle plus élevées', 'adoption plus rapide de nouvelles technologies et processus', 'développement du leadership et mobilité interne renforcés', 'engagement et rétention améliorés', 'plus de constance en qualité, sécurité et exécution'] },
          ...
          { type: 'p', text: "Les organisations à haute performance s'éloignent des initiatives isolées pour construire des écosystèmes d'apprentissage intégrés." },
          { type: 'p', text: 'Ces systèmes sont :' },
          { type: 'ul', items: ['adaptatifs, évoluant avec les besoins business', 'modulaires et à la demande, pour du just-in-time learning', 'orientés application, ancrés dans des tâches et scénarios réels', 'centrés humain, soutenant autonomie, motivation et maîtrise', 'portés par le digital, exploitant data, technologie et plateformes scalables'] },
          ...
          { type: 'h2', text: 'Conclusion' },
          { type: 'p', text: "Les organisations qui domineront demain ne seront pas forcément celles qui ont le plus de ressources, mais celles qui savent apprendre et s'adapter le plus vite." },
          ...
          { type: 'p', text: "Pour les organisations engagées dans la construction d'équipes résilientes et performantes, investir dans l'apprentissage moderne n'est plus optionnel. C'est une décision stratégique qui façonne directement la performance future." },
        ],
      },
    },
  },
  {
    ...
    translations: {
      en: {
        ...
        description: "If KPIs don't move after training, the issue is rarely your people. It's how learning is designed: generic content instead of performance-driven capability building.",
        blocks: [
          ...
          { type: 'p', text: 'Teams attend, participate, and complete the training — but struggle to apply what they have learned in real operational situations.' },
      ...
      fr: {
        ...
        description: "Si les KPI ne bougent pas après une formation, le problème vient rarement des équipes. Il vient souvent d'un apprentissage trop générique, déconnecté de la performance.",
        blocks: [
          ...
          { type: 'p', text: "Les équipes participent, complètent… mais peinent à appliquer ce qu'elles ont appris dans des situations opérationnelles réelles." },
